...
import { CloseIcon } from "@/components/richtext-editor/tiptap-icons/close-icon";
import "@/components/richtext-editor/tiptap-node/image-upload-node/image-upload-node.scss";
