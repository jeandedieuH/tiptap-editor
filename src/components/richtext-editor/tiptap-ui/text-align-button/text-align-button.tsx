...
// --- Icons ---
import { AlignCenterIcon } from "@/components/richtext-editor/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/components/richtext-editor/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/components/richtext-editor/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/components/richtext-editor/tiptap-icons/align-right-icon";
