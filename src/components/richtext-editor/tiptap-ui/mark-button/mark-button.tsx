...
// --- Icons ---
import { BoldIcon } from "@/components/richtext-editor/tiptap-icons/bold-icon";
import { Code2Icon } from "@/components/richtext-editor/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/components/richtext-editor/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/components/richtext-editor/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/components/richtext-editor/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/components/richtext-editor/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/components/richtext-editor/tiptap-icons/underline-icon";
...
import {
  Button,
  ButtonProps,
} from "@/components/richtext-editor/tiptap-ui-primitive/button";
